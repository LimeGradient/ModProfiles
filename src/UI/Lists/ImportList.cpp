#include "ImportList.hpp"

bool ImportList::init(std::string title) {
    ...
    Build<ButtonSprite>::create("Import Pack", "bigFont.fnt", "GJ_button_01.png", 0.8f)
...
ImportList* ImportList::create(std::string title) {
    auto ret = new ImportList();
